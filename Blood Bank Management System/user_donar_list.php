...
mysql_select_db ("bbms");
        ...
        $result = mysql_query("SELECT name,blood_group,sex,contact,dis,mail FROM  donar") 
                or die(mysql_error());  
        ...
        echo "<tr><th>Name</th> <th>Blood Group</th> <th>Gender</th> <th>Phone</th> <th>Living District</th><th>Mail</th>";
